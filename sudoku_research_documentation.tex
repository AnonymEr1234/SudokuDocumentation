 60\documentclass[12pt,a4paper]{article}
...
Die zwei Hauptüberlegungen waren einmal ein CSP-Solver (Constraint Satisfaction Problem) oder ein SAT-Solver (Satisfiability).
...
Wir haben hierfür einmal den durchschnitt der Zeiten pro Solver für das reine lösen ausgewertet und die Anzahl der ausgetimeten durchläufe.
