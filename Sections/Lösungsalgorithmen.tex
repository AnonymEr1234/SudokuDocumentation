...
Wir haben einmal den Durchschnitt der Zeiten pro Solver für das reine Lösen ausgewertet und die Anzahl der abgelaufenen Durchläufe, also die Durchläufe die über eine Sekunde gedauert haben.
    ...
    \begin{figure*}[h!]
        ...
        \label{fig:times_timeouts}
    \end{figure*}

Wie man unschwer in den Graphen~\ref{fig:times_timeouts} erkennen kann, ist der SAT-Solver mit Abstand am schnellsten und löst die Sudokus innerhalb von meist nicht messbarer Zeit. 
